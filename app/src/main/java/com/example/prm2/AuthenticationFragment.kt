...
class AuthenticationFragment : FragmentActivity() {
                ...
                override fun onAuthenticationError(
                    ...
                    if (errorCode == 11) {
                        AlertDialog.Builder(
                            ...
                            setTitle("No biometric credentials enrolled")
                            setMessage("Please set up biometric credentials in settings to use this app.")
                            setCancelable(false)
